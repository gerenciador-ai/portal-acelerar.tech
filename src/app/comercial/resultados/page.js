...
// --- Página de Resultados (Refatorada e Simplificada) ---
export default function ResultadosPage() {
    ...
    // LÓGICA DE BUSCA SIMPLIFICADA: UMA ÚNICA CHAMADA PARA A NOVA ROTA
    useEffect(() => {
        ...
        const fetchData = async () => {
            try {
                ...
                if (!response.ok) {
                    ...
                    throw new Error(errorData.error || 'Falha ao buscar dados de resultados');
                }
    ...
    // Lógica de cálculo dos KPIs (sem alterações, agora deve funcionar corretamente)
