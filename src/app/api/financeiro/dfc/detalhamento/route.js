...
export async function GET(request) {
  ...
  const linhaSolicitada = searchParams.get('grupo'); // Rótulo visual: "(-) DESPESAS FINANCEIRAS"
  ...
  // 3. Janela de busca (LÓGICA DO ROUTE.JS PRINCIPAL)
  ...
  // 4. Buscar dados (LÓGICA DO ROUTE.JS PRINCIPAL)
  ...
  // 5. Processar e filtrar estritamente pela lógica de categorias do Supabase
